...
function App() {
  ...
  if (error) {
    return (
      <p>
        {error.message}, if you get this error, the free API I used might have stopped working, but I created a simple example that demonstrate how this works, <a href='https://codepen.io/Spruce_khalifa/pen/mdXEVKq'> check it out </a>{" "}
      </p>
    );
  } else if (!isLoaded) {
    return <>loading...</>;
